...
namespace ECommerce2.Services
{
    public class ECommerceSystem
    {
        ...
        public void AddNewProduct()
        {
            ...
            {
                Console.Write("Invalid price. Enter a valid price:  Rs");
            }
        ...
        public void CreateOrder()
        {
            ...
            if (order.Items.Count > 0)
            {
                ...
                Console.WriteLine($"Order created successfully! Order ID: {order.Id}, Total: Rs {order.TotalAmount:F2}");
            }
            else
            {
        ...
        public void ProcessPayment()
        {
            ...
            for (int i = 0; i < orders.Count; i++)
            {
                ...
                {
                    Console.WriteLine($"{i + 1}. Order ID: {orders[i].Id}, Amount: Rs {orders[i].TotalAmount:F2}");
                }
            }
        ...
        public void ViewOrders()
        {
            ...
            for (int i = 0; i < orders.Count; i++)
            {
                ...
                Console.WriteLine($"Total Amount: Rs {order.TotalAmount:F2}");
                Console.WriteLine("Items:");
                for (int j = 0; j < order.Items.Count; j++)
                {
                    OrderItem item = order.Items[j];
                    Console.WriteLine($"  - {item.Product.Name} x{item.Quantity} = Rs {item.TotalPrice:F2}");
                }
                Console.WriteLine();
            }
        }
